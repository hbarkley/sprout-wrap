#
# Cookbook Name:: officemac2011
# Recipe:: default
#
# Copyright 2014, MedSnap, LLC.
#
...
dmg_package 'Office Installer' do
  source 'https://fp-pr1.ds.microsoft.com/TransferFile/FileTransfer.dll?Cmd=1&MN=1115134428&Dir=1&Mode=0&Off=0&TS=11CC2D0C-7801-4416-97BB-078709A7A4CA&CVN=5,0,0,32'
  checksum '6CD1A7638AB420490DFDBD57F97FBCBE5A110296'
